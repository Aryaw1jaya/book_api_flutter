...
import 'package:book_api/views/image_view_screen.dart';
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 10),
                              Text(
                                "Year : ${controller.bookDetail!.year!}",
                                style: TextStyle(color: Colors.white70),
                              ),
                              Text(
                                "ISBN : ${controller.bookDetail!.isbn13!}",
                                style: TextStyle(color: Colors.white70),
                              ),
                              Text(
                                "Pages : ${controller.bookDetail!.pages!} Pages",
                                style: TextStyle(color: Colors.white70),
                              ),
                              Text(
